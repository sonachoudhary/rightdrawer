import {
  ...
  CHANGE_LOGIN_ERROR_STATUS,ACCESS_JWTTOKEN,
  SCHOOL_LOGIN_SUCCESS
  ...
  switch (action.type) {
    ...
    case DRIVER_LOGIN_SUCCESS:
      ...
      return {
        ...state,
        isLoggedIn: true,
        // jwtAccessToken: 'ghgjgjhgjhgjhgjgjhjhgjhgjhgjh',
    ...
    case CUSTOMER_REGISTER_SUCCESS:
      return {
        ...state,
        isLoggedIn: true,
        jwtAccessToken: "SSJNDKSIFJDFDSNFDJSNFODDNFKJDSNJSF",
        userType: action.payload.userType,
      };
    case LOGOUT_USER:
      return initialState;
