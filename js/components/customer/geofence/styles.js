...
export default {
  ...
  distanceIOS:{
    fontFamily:'Cabin-Regular', fontSize:16, padding:10, color:'#2A3439', opacity:0.5
  },
  distanceAndroid:{
    fontFamily:'Cabin-Regular', fontSize:16, marginLeft:10, color:'#2A3439', opacity:0.5, marginTop:10
  }
};
