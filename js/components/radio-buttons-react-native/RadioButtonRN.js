                                ...
                                icon && {
                                    ...
                                    <Animated.View style={{
                                        ...
                                        >
                                            {
                                                icon ? 
                                                    <View style={{height:38}}>{ index==0 && <Icon name="check-circle" size={30} color="#3BCAAC" />}
                                                    { index==1 && <Icon name="check-circle" size={30} color="#F65684" />}
                                                    { index==2 && <Icon name="check-circle" size={30} color="#F9AA68" />}</View>
                                                :
