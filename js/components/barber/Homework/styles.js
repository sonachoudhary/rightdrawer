...
export default {
  ...
  headerAndroid:{
   ...
   box:{
    backgroundColor:'#ffff',width:'90%',height:150, borderRadius: 10,position:'absolute',top:110,marginLeft:20,marginRight:20,zIndex:1002 ,elevation: 5,shadowColor: '#000',
   ...
   Smallbox:{
    backgroundColor:'#ffd3ca',height:160, borderRadius: 10,
  ...
  textheadingnewdata:{
     color:"#484347", fontSize:deviceHeight/35, marginTop:5,fontWeight:'600',marginLeft:10,paddingTop:5
  },
  textheading:{
color:"#000", fontSize:18, marginTop:10 ,fontWeight:'400',marginLeft:10
  },
  subtext:{
     color:"#000", fontSize:12,fontWeight:'bold',marginTop:10,marginLeft:10
  },
  boxtext:{
