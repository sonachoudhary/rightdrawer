...
export default {
  ...
  headerAndroid:{
   ...
   box:{
    width:deviceWidth-40,height:70,borderRadius:10,elevation: 5,shadowColor: '#000',margin:'3%',flexDirection:'row',padding:'3%',
   ...
   Smallbox:{
    backgroundColor:'#ffff',width:66,height:60, borderRadius: 10,marginLeft:20,
  ...
  textheadingnewdata:{
     color:"#f7b5b7", fontSize:24, marginTop:12,fontWeight:'600',marginLeft:10,
  },
  textheading:{
color:"#f7b5b7", fontSize:18, marginTop:10 ,fontWeight:'400',marginLeft:10,textAlign:'center',fontWeight:'bold',
  },
  subtext:{
     color:"#707070", fontSize:12,fontWeight:'600',width:'100%',padding:15,lineHeight: 20,
  },
  boxtext:{
