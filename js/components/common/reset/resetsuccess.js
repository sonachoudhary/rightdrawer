          ...
          <View style={{ flex: 1 }}>
            ...
            <Content style={{ backgroundColor: commonColor.brandSecondry , opacity:0.80}}>
              ...
              <View
                ...
                <Text style={{ color:"#E8E8E8", fontSize:28  }}>
                  Password Updated!
                </Text>
              ...
              <View style={{ padding: 50, marginTop: 20,flexDirection:'row', justifyContent:'center' }} >                            
                <Text style={{ width:deviceWidth-150, color:"#E8E8E8", fontSize:14,flexDirection:'row', justifyContent:'center', textAlign:"center"  }}>
                  Your password is now updated. Please login again to access.
                </Text>                
              </View>    
