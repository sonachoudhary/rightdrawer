...
import { Calendar ,CalendarDayComponent,} from 'react-native-toggle-calendar';
import {
  Container,
  Header,
  Content,
...
class Quizhistoryteacher extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <Container>
        <Content style={{ backgroundColor: "#F7F8FB"}}>
         ...
         <Calendar
            current={"2021-05-10"}
            minDate={"2021-06-10"}
            headerData={"2021-12-10"}
            markedDates={"2021-09-10"}
