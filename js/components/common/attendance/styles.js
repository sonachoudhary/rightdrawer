...
export default {
  ...
  savebtn:{
    borderColor:'#2680EB',width:'20%',height:50,borderWidth:1,borderRadius:5,justifyContent:'center',alignItems:'center'
  },
  savebtn2:{
    backgroundColor:'#470B63',width:'10%',height:50,borderWidth:1,borderRadius:5,marginLeft:10,justifyContent:'center',alignItems:'center'
  },
  circleios:{
