...
export default {
  ...
  fieldContainerText:{
    color: "#000000", fontSize:16, marginTop:10, marginBottom:10
  },
  input1:{
    paddingLeft:0,
  ...
  inputvalue:{
    ...
    width:370,marginLeft:20,marginTop:20,borderRadius:8,height:156,color:'#D7D7D7',borderColor:'lightgray',
