  ...
  render() {
    ...
    return (
      <View>
        ...
        <View style={{ position:'absolute', top:20, zIndex:1001 }} >
          <View  style={{ flexDirection:'row', width:width , justifyContent:'center', alignItem:'center' }}>
            <View style= {{ width:100, height:100, backgroundColor:"#FFFFFF", borderRadius:26, justifyContent:'center', alignItem:'center' }}> 
              <Image source={require("../../../assets/icon/logo_black_small.png")} style={{ alignSelf:'center' }} />
            </View>
          </View>
        </View>
        <Carousel
        ...
        <View style={{ position:'absolute', bottom:50, zIndex:1001 }} >
          <View style={{ flexDirection:'row', width:width , justifyContent:'center', alignItem:'center'}}>
              <Text style={{ color:'#ffffff', marginLeft:10, marginTop:5, fontSize:10, fontFamily:'Cabin-Regular'}}>Build Production version 1.1 (2020-08-07)</Text>
          </View>
        </View>
